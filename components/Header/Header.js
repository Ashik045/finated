...
const Header = () => {
  return (
    <div className={style.header_sec}>
        <Image alt='hader' src={headerImg} layout="fill" objectFit="cover" className={style.header_sec_img}/>

    <div className={style.header_sec_main}>
      <h1><span className={style.header_sec_main_count}><CountUp end={2486} duration={3} /></span> job available </h1>
      <h1 className={style.header_sec_main_sh}>You can choose your dream job .</h1>
